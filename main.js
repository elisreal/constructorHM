...
exports.requestInfo = function(){
	if (exports.wordGuess === exports.chosenWord) {
		console.log("YOU WINNNNNNN!!!!!!");
		console.log(exports.chosenWord);
		exports.playAgain();
	}
	if(exports.lives >= 10){
		console.log("You Lose! You're No Longer Saftey Officer.");
		exports.playAgain();
	}
	else{
		var questions = [
	{
		type: "list",
		name: "whatDo",
		message: "Try to guess the name of a Dunder Mifflin Employee.\n Pick Letter or Name.\n You have used "+exports.lives+" out of 10. Be careful.",
		choices:[
		"letter",
		"name"
		]
...
//If the user wants to guess a word, we run inquirer again to guess what word, then pass off to the wordChecker in word.js
			...
			var wordQ = [
			{
				type: "input",
				name: "name",
				message: "Which Office Employee do you think it is?"
			}
			];
